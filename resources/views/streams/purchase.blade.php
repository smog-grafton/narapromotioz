...
@section('title', 'Buy Stream Access - ' . $event->title)
...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col">
            <h1 class="border-start border-primary border-5 ps-3">BUY STREAM ACCESS</h1>
            <p class="text-muted">Get access to live stream {{ $event->title }}.</p>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info" role="alert">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    Stream will be available 30 minutes before the event starts. 
                    ...
                    @if($event->fights->isNotEmpty())
                        <?php $mainEvent = $event->fights->where('is_main_event', true)->first() ?? $event->fights->sortBy('fight_order')->first(); ?>
                        <div class="card mt-3">
        ...
        <!-- Stream Purchase Form -->
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0">Stream Access Purchase</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-primary d-flex align-items-center mb-4">
                        ...
                        <div>
                            <strong>Stream Price:</strong> ${{ number_format($event->stream_price, 2) }}
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <h5>Stream Features:</h5>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center">
                                    <i class="fas fa-check-circle text-success me-3"></i>
                                    <span>High-Definition (HD) quality streaming</span>
                                </li>
                                <li class="list-group-item d-flex align-items-center">
                                    <i class="fas fa-check-circle text-success me-3"></i>
                                    <span>Access on multiple devices (desktop, mobile, tablet)</span>
                                </li>
                                <li class="list-group-item d-flex align-items-center">
                                    <i class="fas fa-check-circle text-success me-3"></i>
                                    <span>Live commentary and professional production</span>
                                </li>
                                <li class="list-group-item d-flex align-items-center">
                                    <i class="fas fa-check-circle text-success me-3"></i>
                                    <span>Replay available for 48 hours after the event</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    
                    <form action="{{ route('streams.store', $event) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" 
                                    ...
                                    placeholder="Your stream access link will be sent to this email">
                            </div>
                            <div class="form-text">
                                We'll send your stream access link to this email address.
                            </div>
                            @error('email')
                        ...
                        <div class="card mb-4 bg-light">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span>${{ number_format($event->stream_price, 2) }}</span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
